...
versions.  The scope
ends with Main Proposition~1; Main Theorems~6--7
and Main Appendix~C concern basis search and are unchanged.  All notation is
that of Unified, in particular $m=s\log(ep/s)$ and
$\delta=(m/n)^{1/2}$.

The common replacement spine is Unified Lemma~1.1, the exact
Schur-complement representation; Lemma~2.1, sparse relative moment
concentration; Theorem~2.2, the residual Schur-field approximation; and
Corollary~2.3, its coefficient specialization.  Unified Appendix~A
contains the concentration and Gaussian-replacement proofs, with
Lemma~A.1 supplying the residual row bounds.  The table below identifies
the endpoint used for each Main claim.
...
\toprule
Main result & Defect & Replacement &
...
Theorem~3.1, (38), specialized through (51). &
...
Theorem~1, lower half of (12); Main Appendix Lemma~7, (35) &
...
Theorem~3.2, (39)--(40), gives the general lower transfer.
Theorem~4.2, (55)--(58), gives the exact scalar replacement;
Lemma~4.3, (60), and Corollary~4.4 give the top-$s$ score-pool
construction. &
...
Theorem~2, (14); Main Appendix Lemma~10, (37) &
...
Theorem~3.1, (38), gives the corrected scale
...
Unified (47) is a sufficient condition. \\
\addlinespace
...
Theorem~3.2, (39)--(40), transfers matched-field quantiles, and
Theorem~3.3, (41)--(42), gives the canonical-metric packing lower bound. &
...
Theorem~4, upper half of (19); Main Appendix Lemma~14, (72) &
\emph{False in general.}  The rate omits the treatment channel, the
statement lacks the treatment and outcome floors needed by a valid
denominator argument, and the proof invokes hypotheses absent from the theorem.
Its centered studentizer transfer is not proved; see
Proposition~\ref{prop:obstructions}(ii). &
Theorem~5.1: corrected upper bound (79), aligned upper bound (80), and
least-squares transfer (81)--(82).  Corollary~5.2, (86), gives the
...
floor.  Both variance floors are required; the null and local testing
condition are additionally required for the displayed rate and
least-squares transfer.  Sparse treatment alignment recovers the old
rate.  Main Assumption~2 is unnecessary for this upper bound. \\
\addlinespace
...
Corollary~5.3, (87), gives matched-field transfer.  Corollary~5.4,
(88)--(91), gives the score-packing lower bound.  Unified
Lemmas~C.2--C.3 give the score-to-direction bridge. &
...
Theorem~5, (21); Main Appendix Lemmas~19--20 &
...
Theorem~2.2, (19)--(25), is the general stochastic approximation.
Theorems~4.1 and 4.5--4.6, (48)--(49), (62), and (64), give
covariance-aware and observable top-$s$ reductions.  Theorem~4.7, (68),
and Corollary~4.8,
(71), give independent products. &
...
score isotropy (66), the mean cap (67), $m\to\infty$, and $m=o(n)$.
The route needs neither $m^4=o(n)$ nor $\log p=o(n^{1/3})$. \\
\addlinespace

Main Appendix Proposition~1, (78) &
...
None.  Corollary~4.8, (71), is only a relative-scale approximation and
...
\midrule
Main Appendix~A.1--A.3 common machinery &
Unified Lemma~1.1, Lemma~2.1, Theorem~2.2, and Corollary~2.3;
Unified Appendix~A, especially Lemma~A.1. \\
\addlinespace
Theorems~1--3 and their proofs &
Unified Theorems~3.1--3.3 and 4.2, and Corollary~4.4. \\
\addlinespace
Theorem~4 and Main Appendix~A.3 &
Unified Section~5, especially Theorem~5.1 and
Corollaries~5.2--5.4 and Lemmas~C.2--C.3. \\
\addlinespace
Theorem~5 and Main Appendix~B &
Unified Section~4, Theorems~4.1 and 4.5--4.7 and Corollary~4.8;
Unified Lemma~B.1 and the Unified Appendix~B proof of Theorem~4.7. \\
\addlinespace
Theorems~6--7 and Main Appendix~C &
...
comparison.  Main Appendix~B's fixed-factor extension also leaves Lemma~22
...
matching only through Theorem~4.2 or Corollary~4.4; Main (5) should use
the corrected scale in Unified (38); and Main (6) should present
the hierarchy in Unified Theorems~4.1 and 4.5--4.7 and Corollary~4.8.  Its
remainder should agree with Unified (71), not claim the stronger
...
\]
for large $M$.  A block eigenvalue floor cannot justify Main Appendix
Lemma~7.
\end{enumerate}
\end{proposition}
...
Lemma~C.1 similarly gives $O_{\Prob}(1+L/\sqrt n)=O_{\Prob}(1)$
